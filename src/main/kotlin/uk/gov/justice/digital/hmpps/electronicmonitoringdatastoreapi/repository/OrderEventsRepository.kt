...
class OrderEventsRepository(
  ...
  fun getMonitoringEventsList(orderId: String, allowSpecials: Boolean): List<AthenaMonitoringEventDTO> {
  ...
  fun getIncidentEventsList(orderId: String, allowSpecials: Boolean): List<AthenaIncidentEventDTO> {
  ...
  fun getViolationEventsList(orderId: String, allowSpecials: Boolean): List<AthenaViolationEventDTO> {
  ...
  fun getContactEventsList(orderId: String, allowSpecials: Boolean): List<AthenaContactEventDTO> {
