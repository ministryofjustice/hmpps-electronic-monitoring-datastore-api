...
@Service
class AmServicesRepository(
  @Autowired val athenaClient: EmDatastoreClientInterface,
  @Value("\${services.athena.database}")
  var athenaDatabase: String = "unknown_database",
) {
  fun getServices(legacySubjectId: String, role: AthenaRole): List<AthenaAmServiceDTO> {
    ...
    return AthenaHelper.Companion.mapTo<AthenaAmServiceDTO>(athenaResponse)
  }
}
