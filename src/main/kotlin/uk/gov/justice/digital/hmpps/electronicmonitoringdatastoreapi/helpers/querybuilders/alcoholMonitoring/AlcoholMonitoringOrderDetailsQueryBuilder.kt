...
import uk.gov.justice.digital.hmpps.electronicmonitoringdatastoreapi.helpers.querybuilders.AthenaAlcoholMonitoringOrderDetailsQuery
import uk.gov.justice.digital.hmpps.electronicmonitoringdatastoreapi.helpers.querybuilders.SqlQueryBuilder
import java.time.LocalDate

class AlcoholMonitoringOrderDetailsQueryBuilder :
  SqlQueryBuilder(
    "am_order_details",
    arrayOf(
      "legacy_subject_id",
  ...
  fun withLegacySubjectId(legacySubjectId: String?): AlcoholMonitoringOrderDetailsQueryBuilder {
  ...
  fun withFirstName(value: String?): AlcoholMonitoringOrderDetailsQueryBuilder {
  ...
  fun withLastName(value: String?): AlcoholMonitoringOrderDetailsQueryBuilder {
  ...
  fun withAlias(value: String?): AlcoholMonitoringOrderDetailsQueryBuilder {
  ...
  fun withDob(dateOfBirth: LocalDate?): AlcoholMonitoringOrderDetailsQueryBuilder {
    if (dateOfBirth == null) {
      return this
    }
  ...
  override fun build(databaseName: String): AthenaAlcoholMonitoringOrderDetailsQuery = AthenaAlcoholMonitoringOrderDetailsQuery(getSQL(databaseName), values.toTypedArray())
}
