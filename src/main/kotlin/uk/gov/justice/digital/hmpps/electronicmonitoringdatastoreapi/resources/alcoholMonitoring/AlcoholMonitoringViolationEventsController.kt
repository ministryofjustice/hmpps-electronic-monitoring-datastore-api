...
@RestController
class AlcoholMonitoringViolationEventsController(
  ...
  ): ResponseEntity<List<AlcoholMonitoringEvent<AlcoholMonitoringViolationEventDetails>>> {
    val result = alcoholMonitoringOrderEventsService.getViolationEvents(legacySubjectId)
