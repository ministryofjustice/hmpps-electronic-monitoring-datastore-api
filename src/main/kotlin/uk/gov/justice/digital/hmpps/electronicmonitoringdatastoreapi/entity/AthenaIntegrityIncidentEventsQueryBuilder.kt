...
class AthenaIntegrityIncidentEventsQueryBuilder :
  SqlQueryBuilderBase<AthenaIntegrityIncidentEventDTO>(
    "incident",
    AthenaIntegrityIncidentEventDTO::class,
  ) {
  fun withLegacySubjectId(legacySubjectId: String?): AthenaIntegrityIncidentEventsQueryBuilder {
