...
class AthenaIntegrityMonitoringEventsQueryBuilder :
  SqlQueryBuilderBase<AthenaIntegrityMonitoringEventDTO>(
    "event_history",
    AthenaIntegrityMonitoringEventDTO::class,
  ) {
  fun withLegacySubjectId(legacySubjectId: String?): AthenaIntegrityMonitoringEventsQueryBuilder {
