...
class AmOrderInformationController(
  @Autowired val orderInformationService: AmOrderInformationService,
  ...
  @RequestMapping(
    ...
    path = [
      "/alcohol-monitoring/{legacySubjectId}/information",
    ],
  ...
  fun getOrderInformation(
    ...
    val result = orderInformationService.getOrderInformation(legacySubjectId, validatedRole)
