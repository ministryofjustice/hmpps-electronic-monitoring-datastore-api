...
class AthenaAlcoholMonitoringViolationEventsQueryBuilder :
  SqlQueryBuilderBase<AthenaAlcoholMonitoringViolationEventDTO>(
    "am_violations",
    AthenaAlcoholMonitoringViolationEventDTO::class,
  ) {
  fun withLegacySubjectId(legacySubjectId: String?): AthenaAlcoholMonitoringViolationEventsQueryBuilder {
