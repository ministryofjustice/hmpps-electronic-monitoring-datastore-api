...
class OrderInformationRepository {
  companion object {
    ...
    fun getOrderInformation(orderId: String): OrderInformation? = orders.find { it.keyOrderInformation.legacyOrderId == orderId }
    ...
    private fun generateDocuments(): List<Document> = listOf(
