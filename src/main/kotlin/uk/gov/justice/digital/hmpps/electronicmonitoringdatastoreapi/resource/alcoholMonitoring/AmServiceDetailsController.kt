...
@RestController
class AmServiceDetailsController(
  @param:Autowired private val amServiceDetailsService: AmServiceDetailsService,
  ...
  ): ResponseEntity<List<AmServiceDetails>> {
    val validatedRole = athenaRoleService.getRoleFromAuthentication(authentication)

    val result = amServiceDetailsService.getServiceDetails(legacySubjectId, validatedRole)
