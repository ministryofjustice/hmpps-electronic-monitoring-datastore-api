...
import uk.gov.justice.digital.hmpps.electronicmonitoringdatastoreapi.services.alcoholMonitoring.AlcoholMonitoringEquipmentDetailsService
...
@RestController
class AlcoholMonitoringEquipmentDetailsController(
  @param:Autowired private val alcoholMonitoringEquipmentDetailsService: AlcoholMonitoringEquipmentDetailsService,
  ...
  ): ResponseEntity<List<AlcoholMonitoringEquipmentDetails>> {
    val result = alcoholMonitoringEquipmentDetailsService.getEquipmentDetails(legacySubjectId)

    auditService.createEvent(
      authentication.name,
      "GET_ALCOHOL_MONITORING_EQUIPMENT_DETAILS",
      mapOf(
