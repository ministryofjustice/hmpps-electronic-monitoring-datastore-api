...
class AthenaIntegrityServiceDetailsQueryBuilder :
  SqlQueryBuilderBase<AthenaIntegrityServiceDetailsDTO>(
    "services",
    AthenaIntegrityServiceDetailsDTO::class,
  ) {
  fun withLegacySubjectId(legacySubjectId: String?): AthenaIntegrityServiceDetailsQueryBuilder {
