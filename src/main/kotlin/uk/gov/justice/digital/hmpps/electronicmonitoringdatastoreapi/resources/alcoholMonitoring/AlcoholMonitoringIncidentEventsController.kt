...
import uk.gov.justice.digital.hmpps.electronicmonitoringdatastoreapi.services.alcoholMonitoring.AlcoholMonitoringOrderEventsService
...
@RestController
class AlcoholMonitoringIncidentEventsController(
  @param:Autowired private val alcoholMonitoringOrderEventsService: AlcoholMonitoringOrderEventsService,
  ...
  ): ResponseEntity<List<AlcoholMonitoringEvent<AlcoholMonitoringIncidentEventDetails>>> {
    val result = alcoholMonitoringOrderEventsService.getIncidentEvents(legacySubjectId)

    auditService.createEvent(
      authentication.name,
      "GET_ALCOHOL_MONITORING_INCIDENT_EVENTS",
      mapOf(
