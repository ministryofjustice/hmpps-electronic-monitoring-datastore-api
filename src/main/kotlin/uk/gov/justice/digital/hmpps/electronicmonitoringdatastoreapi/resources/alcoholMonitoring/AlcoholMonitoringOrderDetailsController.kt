...
class AlcoholMonitoringOrderDetailsController(
  ...
  fun executeSearch(
    ...
    val queryExecutionId = alcoholMonitoringOrderDetailsService.getQueryExecutionId(orderSearchCriteria, restricted)
  ...
  fun getSearchResults(
    ...
    val results = alcoholMonitoringOrderDetailsService.getSearchResults(queryExecutionId, restricted)
