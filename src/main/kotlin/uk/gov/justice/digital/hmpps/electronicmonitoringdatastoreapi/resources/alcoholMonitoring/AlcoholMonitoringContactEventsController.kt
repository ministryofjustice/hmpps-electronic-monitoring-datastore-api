...
@RestController
class AlcoholMonitoringContactEventsController(
  ...
  ): ResponseEntity<List<AlcoholMonitoringEvent<AlcoholMonitoringContactEventDetails>>> {
    val result = alcoholMonitoringOrderEventsService.getContactEvents(legacySubjectId)
