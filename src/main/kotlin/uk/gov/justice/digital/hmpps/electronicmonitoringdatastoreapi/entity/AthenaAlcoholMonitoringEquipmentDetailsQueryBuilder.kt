...
class AthenaAlcoholMonitoringEquipmentDetailsQueryBuilder :
  SqlQueryBuilderBase<AthenaAlcoholMonitoringEquipmentDetailsDTO>(
    "am_equipment_details",
    AthenaAlcoholMonitoringEquipmentDetailsDTO::class,
  ) {
  fun withLegacySubjectId(legacySubjectId: String?): AthenaAlcoholMonitoringEquipmentDetailsQueryBuilder {
