...
import uk.gov.justice.digital.hmpps.electronicmonitoringdatastoreapi.services.alcoholMonitoring.AlcoholMonitoringVisitDetailsService
...
@RestController
class AlcoholMonitoringVisitDetailsController(
  @param:Autowired private val alcoholMonitoringVisitDetailsService: AlcoholMonitoringVisitDetailsService,
  ...
  ): ResponseEntity<List<AlcoholMonitoringVisitDetails>> {
