...
class AthenaIntegrityVisitDetailsQueryBuilder :
  SqlQueryBuilderBase<AthenaIntegrityVisitDetailsDTO>(
    "visit_details",
    AthenaIntegrityVisitDetailsDTO::class,
  ) {
  fun withLegacySubjectId(legacySubjectId: String?): AthenaIntegrityVisitDetailsQueryBuilder {
