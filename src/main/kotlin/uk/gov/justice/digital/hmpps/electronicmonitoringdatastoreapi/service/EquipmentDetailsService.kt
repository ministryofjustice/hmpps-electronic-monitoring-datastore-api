...
class EquipmentDetailsService(
  ...
  fun getEquipmentDetails(orderId: String, allowSpecials: Boolean): List<EquipmentDetails> {
    val result = equipmentDetailsRepository.getEquipmentDetails(orderId, allowSpecials)
