...
class EquipmentDetailsService(
  ...
  fun getEquipmentDetails(legacySubjectId: String, allowSpecials: Boolean = false): List<EquipmentDetails> {
    val result = equipmentDetailsRepository.getEquipmentDetails(legacySubjectId, allowSpecials)
