...
class AthenaIntegrityEquipmentDetailsQueryBuilder :
  SqlQueryBuilderBase<AthenaIntegrityEquipmentDetailsDTO>(
    "equipment_details",
    AthenaIntegrityEquipmentDetailsDTO::class,
  ) {
  fun withLegacySubjectId(legacySubjectId: String?): AthenaIntegrityEquipmentDetailsQueryBuilder {
