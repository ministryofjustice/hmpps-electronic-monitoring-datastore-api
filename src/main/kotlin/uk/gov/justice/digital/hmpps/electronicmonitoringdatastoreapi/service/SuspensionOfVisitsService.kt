...
class SuspensionOfVisitsService(
  ...
  fun getSuspensionOfVisits(orderId: String, allowSpecials: Boolean): List<SuspensionOfVisits> {
    val result = suspensionOfVisitsRepository.getSuspensionOfVisits(orderId, allowSpecials)
