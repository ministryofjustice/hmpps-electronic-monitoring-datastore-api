...
class AthenaAlcoholMonitoringIncidentEventsQueryBuilder :
  SqlQueryBuilderBase<AthenaAlcoholMonitoringIncidentEventDTO>(
    "am_incident",
    AthenaAlcoholMonitoringIncidentEventDTO::class,
  ) {
  fun withLegacySubjectId(legacySubjectId: String?): AthenaAlcoholMonitoringIncidentEventsQueryBuilder {
