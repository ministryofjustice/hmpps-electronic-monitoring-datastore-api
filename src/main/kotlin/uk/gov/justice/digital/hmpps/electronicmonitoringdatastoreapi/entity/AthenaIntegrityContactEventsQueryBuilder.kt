...
class AthenaIntegrityContactEventsQueryBuilder :
  SqlQueryBuilderBase<AthenaIntegrityContactEventDTO>(
    "contact_history",
    AthenaIntegrityContactEventDTO::class,
  ) {
  fun withLegacySubjectId(legacySubjectId: String?): AthenaIntegrityContactEventsQueryBuilder {
