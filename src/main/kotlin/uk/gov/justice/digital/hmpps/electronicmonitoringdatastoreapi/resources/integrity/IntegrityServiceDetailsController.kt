...
import uk.gov.justice.digital.hmpps.electronicmonitoringdatastoreapi.services.integrity.IntegrityServiceDetailsService
...
@RestController
class IntegrityServiceDetailsController(
  @field:Autowired val integrityServiceDetailsService: IntegrityServiceDetailsService,
  ...
  fun getServiceDetails(
    ...
    val result = integrityServiceDetailsService.getServiceDetails(legacySubjectId, restricted)

    auditService.createEvent(
      authentication.name,
      "GET_INTEGRITY_SERVICE_DETAILS",
      mapOf(
