...
import uk.gov.justice.digital.hmpps.electronicmonitoringdatastoreapi.helpers.querybuilders.AthenaIntegrityContactEventsListQuery
...
class IntegrityContactEventsQueryBuilder :
  ...
  override fun build(databaseName: String): AthenaIntegrityContactEventsListQuery = AthenaIntegrityContactEventsListQuery(getSQL(databaseName), values.toTypedArray())
}
