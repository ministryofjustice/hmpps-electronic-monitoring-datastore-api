...
class OrderRepository {
  companion object {
    ...
    fun parseOrders(resultString: String): List<Order>{
  ...
  fun getOrders(criteria: SearchCriteria): AthenaQueryResponse<List<Order>> {
    ...
    return try {
      val athenaResponse: String = athenaService.getQueryResult(role, athenaQuery.queryString)
