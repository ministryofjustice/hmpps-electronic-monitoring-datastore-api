...
class SuspensionOfVisitsControllerTest {
  ...
  inner class GetSuspensionOfVisits {
    ...
    fun `gets order information from order service`() {
      ...
      Mockito.`when`(suspensionOfVisitsService.getSuspensionOfVisits(orderId, false)).thenReturn(expectedResult)
      ...
      Mockito.verify(suspensionOfVisitsService, Mockito.times(1)).getSuspensionOfVisits(orderId, false)
    }
  }
}
