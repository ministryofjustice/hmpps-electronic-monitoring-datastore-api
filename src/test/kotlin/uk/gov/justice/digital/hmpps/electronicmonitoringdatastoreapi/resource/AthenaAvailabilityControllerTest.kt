...
import uk.gov.justice.digital.hmpps.electronicmonitoringdatastoreapi.service.AthenaAvailabilityService
import uk.gov.justice.digital.hmpps.electronicmonitoringdatastoreapi.service.internal.AuditService

@ActiveProfiles("test")
@JsonTest
class AthenaAvailabilityControllerTest {
  private lateinit var availabilityService: AthenaAvailabilityService
  private lateinit var auditService: AuditService
  private lateinit var controller: AthenaAvailabilityController
  ...
  fun setup() {
    ...
    availabilityService = mock(AthenaAvailabilityService::class.java)
    auditService = mock(AuditService::class.java)
    controller = AthenaAvailabilityController(availabilityService, auditService)
  }
