...
class AlcoholMonitoringEquipmentDetailsRepositoryTest {
  ...
  fun setup() {
    ...
    alcoholMonitoringEquipmentDetailsRepository = AlcoholMonitoringEquipmentDetailsRepository(emDatastoreClient)
  }
  ...
  inner class GetEquipmentDetails {
    ...
    fun `getEquipmentDetails passes correct query to getQueryResult`() {
      ...
      alcoholMonitoringEquipmentDetailsRepository.findByLegacySubjectId("123")
    ...
    fun `getEquipmentDetails returns all the results from getQueryResult`() {
      ...
      val result = alcoholMonitoringEquipmentDetailsRepository.findByLegacySubjectId("000")
