...
class AthenaIntegrityViolationEventDTOTest {
  ...
  inner class Construct {
    ...
    @Test
    fun `AthenaIntegrityViolationEventDTO can be mapped with all attributes`() {
    ...
    @Test
    fun `AthenaIntegrityViolationEventDTO can be mapped with just ids `() {
      val athenaResponseString = MockAthenaResultSetBuilder(
        columns = columnNames,
        rows = arrayOf(
          arrayOf(
