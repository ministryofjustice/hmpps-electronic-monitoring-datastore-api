...
class EquipmentDetailsRepositoryTest {
  private lateinit var emDatastoreClient: EmDatastoreClient
  private lateinit var repository: EquipmentDetailsRepository

  @BeforeEach
  fun setup() {
    emDatastoreClient = Mockito.mock(EmDatastoreClient::class.java)
    repository = EquipmentDetailsRepository(emDatastoreClient)
  }

  @Test
  fun `EquipmentDetailsRepository can be instantiated`() {
    val sut = EquipmentDetailsRepository(Mockito.mock(EmDatastoreClient::class.java))
