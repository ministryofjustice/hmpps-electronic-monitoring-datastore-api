...
## Contents
- [hmpps-electronic-monitoring-datastore-api](#hmpps-electronic-monitoring-datastore-api)
  - [Contents](#contents)
  ...
  - [Usage](#usage)
    ...
    - [Checking the app has started successfully:](#checking-the-app-has-started-successfully)
    - [Running with Docker](#running-with-docker)
    - [Running the application locally using Intellij](#running-the-application-locally-using-intellij)
  - [Vulnerability analysis](#vulnerability-analysis)
    - [Code coverage](#code-coverage)
  - [Deployment](#deployment)
  - [Note on remaining TODOs and Examples from template app](#note-on-remaining-todos-and-examples-from-template-app)
